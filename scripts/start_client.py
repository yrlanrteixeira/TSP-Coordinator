    ...
    try:
        ...
        for name, problem in problems.items():
            ...
            if result:
                ...
                print(f"✅ {name}: Cost = {result['best_solution']['best_cost']:.2f}, Time = {total_time:.2f}s")
...
def main():
    ...
    solve_parser.add_argument('--file', required=True, help='JSON file with TSP problem')
    ...
    gen_parser.add_argument('--cities', type=int, required=True, help='Number of cities')
    ...
    bench_parser.add_argument('--output-dir', default='benchmark_results',
